...
description: >
  ...
  Use this skill when: (1) Writing new Quarto documents (.qmd) with best practices, (2) Understanding Quarto's
  code cell syntax with hashpipe (#|) options, (3) Setting up cross-references
  for figures, tables, sections, and equations, (4) Using Quarto-specific markdown
  features like callouts, divs, and spans, (5) Configuring YAML front matter for
  documents and projects, (6) Finding and using Quarto extensions.
---
