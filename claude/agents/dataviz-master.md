---
name: dataviz-master
description: Create publication-quality scientific and bioinformatics figures in Python. Specializes in matplotlib, seaborn, plotly with focus on clarity, reproducibility, and export quality.
