...
description: Use this agent when you have completed an architectural plan or design document and need critical evaluation before implementation. This agent should be called after creating system designs, API specifications, database schemas, or any architectural decisions to identify potential issues and explore alternatives.\n\nExamples:\n- <example>\nContext: User has designed a Dagster data pipeline architecture.\nuser: "I've designed a pipeline with 3 assets for processing experimental results. Here's the architecture..."\nassistant: "Let me use the architecture-devils-advocate agent to critically evaluate this design and explore potential alternatives."\n<commentary>\nThe user has completed a pipeline architecture and needs critical review before implementation.\n</commentary>\n</example>\n- <example>\nContext: User has created a database schema for a new feature.\nuser: "I've finalized the database schema for storing analysis results. The tables are..."\nassistant: "Now I'll use the architecture-devils-advocate agent to audit this schema for potential issues and suggest alternatives."\n<commentary>\nA database schema is an architectural decision that should be critically reviewed.\n</commentary>\n</example>
